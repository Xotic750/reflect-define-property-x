 ...
 */
"use strict";var attempt=_dereq_("attempt-x"),assertIsObject=_dereq_("assert-is-object-x"),$defineProperty=_dereq_("object-define-property-x"),objectKeys=_dereq_("attempt-x"),arrayIncludes=_dereq_("array-includes-x"),has=_dereq_("has-own-property-x"),getOwnPropertyDescriptor=_dereq_("object-get-own-property-descriptor-x"),some=_dereq_("array-some-x"),testObj=$defineProperty({},"test",{configurable:!0,enumerable:!0,value:"Testing",writable:!1}),res=attempt(function(){testObj.test=!0}),supportsWritable=res.threw||"Testing"===testObj.test;testObj=$defineProperty({},"test",{configurable:!0,enumerable:!1,value:"Testing",writable:!0});var supportsEnumerable=!1===arrayIncludes(objectKeys(testObj),"test");testObj=$defineProperty({},"test",{configurable:!1,enumerable:!0,value:"Testing",writable:!0});var supportsConfigurable=(res=attempt(function(){delete testObj.test})).threw||"Testing"===testObj.test,toComparableDescriptor=function _toComparableDescriptor(desc){var descriptor={};return supportsEnumerable&&(descriptor.enumerable=Boolean(desc.enumerable)),supportsConfigurable&&(descriptor.configurable=Boolean(desc.configurable)),has(desc,"value")&&(descriptor.value=desc.value),supportsWritable&&(descriptor.writable=Boolean(desc.writable)),has(desc,"get")&&(descriptor.get=desc.get),has(desc,"set")&&(descriptor.set=desc.set),descriptor},areDescriptorsEqual=function _areDescriptorsEqual(actualObj,atributesObj,propertyKey){var actual=toComparableDescriptor(getOwnPropertyDescriptor(actualObj,propertyKey)),requested=toComparableDescriptor(atributesObj),actualKeys=objectKeys(actual);return actualKeys.length===objectKeys(requested).length&&!1===some(actualKeys,function(key){return actual[key]!==requested[key]})};module.exports=function defineProperty(target,propertyKey,attributes){assertIsObject(target);var result=attempt($defineProperty,target,propertyKey,attributes);return!result.threw&&areDescriptorsEqual(result.value,attributes,propertyKey)}},{"array-includes-x":2,"array-some-x":4,"assert-is-object-x":6,"attempt-x":7,"has-own-property-x":11,"object-define-property-x":34,"object-get-own-property-descriptor-x":35}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":19,"is-primitive":25,"safe-to-string-x":39}],6:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsObject(value){if(isPrimitive(value))throw new TypeError(safeToString(value)+" is not an object");return value}},{"is-primitive":25,"safe-to-string-x":39}],7:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),hop=Object.prototype.hasOwnProperty;module.exports=function hasOwnProperty(object,property){return hop.call(toObject(object),toPropertyKey(property))}},{"to-object-x":46,"to-property-key-x":48}],12:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":23}],19:[function(_dereq_,module,exports){/**
 ...
 * @module is-integer-x
 */
"use strict";var numberIsFinite=_dereq_("is-finite-x"),toInteger=_dereq_("to-integer-x");module.exports=function isInteger(value){return numberIsFinite(value)&&toInteger(value)===value}},{"is-finite-x":18,"to-integer-x":43}],22:[function(_dereq_,module,exports){/**
 ...
 * @module is-length-x
 */
"use strict";var isSafeInteger=_dereq_("is-safe-integer-x");module.exports=function isLength(value){return isSafeInteger(value)&&value>=0}},{"is-safe-integer-x":26}],23:[function(_dereq_,module,exports){/**
 ...
 * @module is-nan-x
 */
"use strict";module.exports=function isNaN(value){return value!==value}},{}],24:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":23,"to-number-x":45}],32:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],33:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":53,"white-space-x":55}],34:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":27}],38:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":24}],39:[function(_dereq_,module,exports){/**
 ...
 * @module same-value-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function sameValue(value1,value2){return 0===value1&&0===value2?1/value1==1/value2:value1===value2||!(!numberIsNaN(value1)||!numberIsNaN(value2))}},{"is-nan-x":23}],41:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var sameValue=_dereq_("same-value-x");module.exports=function sameValueZero(x,y){return x===y||sameValue(x,y)}},{"same-value-x":40}],42:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":32,"to-integer-x":43}],45:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function toObject(value){return Object(requireObjectCoercible(value))}},{"require-object-coercible-x":38}],47:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x");module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?key:toStr(key)}},{"has-symbol-support-x":12,"to-primitive-x":47,"to-string-x":50}],49:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":29,"validate.io-undefined":54}],50:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":28}],51:[function(_dereq_,module,exports){/**
 ...
 * @module trim-left-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reLeft=new RegExp("^["+_dereq_("white-space-x").string+"]+");module.exports=function trimLeft(string){return $toString(string).replace(reLeft,"")}},{"to-string-x":50,"white-space-x":55}],52:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reRight=new RegExp("["+_dereq_("white-space-x").string+"]+$");module.exports=function trimRight(string){return $toString(string).replace(reRight,"")}},{"to-string-x":50,"white-space-x":55}],53:[function(_dereq_,module,exports){/**
